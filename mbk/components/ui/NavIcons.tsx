/** Inline SVG icons (Lucide paths) — avoids lucide-react client/SSR hydration drift with React 19. */
...
/** Matches lucide-react ExternalLink sizing used in Projects (strokeWidth 1.75). */
